I created this extension with the help of Google Gemini to fulfill a simple need (more like a want) on my company's internal Wiki.  This does not make any database changes.
